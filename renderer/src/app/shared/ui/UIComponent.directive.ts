...
import { ApplicationRef, ChangeDetectorRef, ComponentRef, createComponent, Directive, ElementRef, HostBinding, Inject, Injectable, input, output, signal, Type } from '@angular/core';
import { UIAction, UIConfig, UIDismissData } from 'src/app/shared/ui/ui.types';
...
export abstract class UIComponent {
    ...
    public disappearing = signal<boolean>(false);
